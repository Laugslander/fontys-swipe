...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val colors = arrayOf(colorFontysPrimary, colorFontysBlend, colorFontysSecondary)
        var currentColor = 0
        controller.topRoutes.forEach { route ->
            ...
            pie_chart.addPieSlice(PieModel(route.name, route.score.toFloat(), getColor(this, colors[currentColor])))
        }
